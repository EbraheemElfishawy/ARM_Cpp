...
void    NVIC_VoidEnablePeripheral  ( uint8_t Copy_u8INTID );

void    NVIC_VoidDisablePeripheral ( uint8_t Copy_u8INTID );

void    NVIC_VoidSetPending        ( uint8_t Copy_u8INTID );

void    NVIC_VoidClearPending      ( uint8_t Copy_u8INTID );

uint8_t NVIC_u8GetActive           ( uint8_t Copy_u8INTID );
